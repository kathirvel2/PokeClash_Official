...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	{
		name: "[Gen 9] PokeClash Competitive",
		mod: 'fullgimmick',
		searchShow: false,
		debug: true,
		battle: { trunc: Math.trunc },
		ruleset: [
			'Team Preview', 'Cancel Mod', 'Max Team Size = 24', 'Max Move Count = 24', 'Max Level = 9999', 'Default Level = 100',
			'+Past', '+Future', '+Unreleased', '+CAP',
	...
	},
	{
		...
		validateSet(set, teamHas) {
			if (!teamHas.abilityMap) {
				...
				for (const pokemon of this.dex.species.all()) {
